...
{
    public class EditStudentSubjectValidations : AbstractValidator<EditStudentSubjectCommand>
    {
        private readonly IStudentService _studentService;
        private readonly ISubjectService _subjectService;


        public EditStudentSubjectValidations(IStudentService studentService, ISubjectService subjectService)
        {
